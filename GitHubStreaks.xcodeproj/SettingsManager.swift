...
class SettingsManager: ObservableObject {
    ...
    private init() {
        ...
        self.menuBarShowStreak = userDefaults.bool(forKey: "menuBarShowStreak")
        ...
        if !userDefaults.bool(forKey: "menuBarShowStreakSet") {
            self.menuBarShowStreak = true
            userDefaults.set(true, forKey: "menuBarShowStreakSet")
        }
    }
}